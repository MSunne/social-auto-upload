...
var adminPermissionCatalog = []store.UpsertAdminPermissionInput{
	...
	{Code: "ai.read", Name: "Read AI Models", Description: "查看 AI 模型目录与可用配置", Category: "ai"},
	{Code: "ai.update", Name: "Update AI Models", Description: "新增、更新 AI 模型配置", Category: "ai"},
	{Code: "skill.read", Name: "Read Skills", Description: "查看公共技能列表与状态", Category: "skill"},
	{Code: "skill.update", Name: "Update Skills", Description: "更新公共技能启用状态", Category: "skill"},
